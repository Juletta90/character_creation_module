...
class Character:
    ...
    # А диапазон значений защиты вынесите в виде кортежа в
    # переменную класса Character, назовите эту переменную
    # RANGE_VALUE_DEFENCE и задайте ей значение от 1 до 5.
...
def start_training(character):
    ...
    while cmd != 'skip':
        ...
        if cmd in commands:
            print(character.name, commands[cmd])
